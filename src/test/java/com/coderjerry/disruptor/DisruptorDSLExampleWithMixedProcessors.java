...
import com.coderjerry.disruptor.DisruptorDSLExampleWithSingleProducer.ExampleEvent;
 ...
 * jerry li
 */
public class DisruptorDSLExampleWithMixedProcessors {
  ...
  public void createDisruptor(final CountDownLatch latch){
    ...
    EventHandler unmarshallHandler = new EventHandler() { // 最慢
      ...
      public void onEvent(Object event, long sequence, boolean endOfBatch) throws Exception {
        Thread.sleep(1*1000);
        if(event instanceof DisruptorDSLExampleWithSingleProducer.ExampleEvent){
          ((DisruptorDSLExampleWithSingleProducer.ExampleEvent)event).ext = "unmarshalled ";
        }
    ...
    disruptor
        ...
        .thenHandleEventsWithWorkerPool(new WorkHandler[]{
            resultHandler,
            resultHandler,
            resultHandler
        });
  ...
  public static void main(String[] args) {
    ...
    DisruptorDSLExampleWithMixedProcessors disruptorDSLExample = new DisruptorDSLExampleWithMixedProcessors();
